[React Admin - Open-Source Framework for B2B applications (marmelab.com)](https://marmelab.com/react-admin/)\
...
[![React-Admin tutorial overview](https://marmelab.com/react-admin/img/tutorial_overview.gif)](https://marmelab.com/react-admin/img/tutorial_overview.gif)
...
**Tip**: Although this tutorial uses a TypeScript template, you can use react-admin with JavaScript if you prefer. Also, you can use [create-react-app](https://marmelab.com/react-admin/CreateReactApp.html), [Next.js](https://marmelab.com/react-admin/NextJs.html), [Remix](https://marmelab.com/react-admin/Remix.html), or any other React framework to create your admin app. React-admin is framework-agnostic.
...
[![Empty Admin](https://marmelab.com/react-admin/img/tutorial_empty.png)](https://marmelab.com/react-admin/img/tutorial_empty.png)
...
The `list={ListGuesser}` tells react-admin to use the `<ListGuesser>` component to display the list of users. This component _guesses_ the configuration to use for the list (column names and types) based on the data fetched from the API.

The app can now display a list of users:

[![Users List](https://marmelab.com/react-admin/img/tutorial_users_list.png)](https://marmelab.com/react-admin/img/tutorial_users_list.png)
...
[![Guessed Users List](https://marmelab.com/react-admin/img/tutorial_guessed_list.png)](https://marmelab.com/react-admin/img/tutorial_guessed_list.png)
...
[![Users List](https://marmelab.com/react-admin/img/tutorial_simple_list.webp)](https://marmelab.com/react-admin/img/tutorial_simple_list.webp)
...
[![Mobile user list](https://marmelab.com/react-admin/img/tutorial_mobile_user_list.gif)](https://marmelab.com/react-admin/img/tutorial_mobile_user_list.gif)
...
[![Responsive List](https://marmelab.com/react-admin/img/tutorial_user_list_responsive.gif)](https://marmelab.com/react-admin/img/tutorial_user_list_responsive.gif)
...
[![Users List](https://marmelab.com/react-admin/img/tutorial_users_list_selected_columns.png)](https://marmelab.com/react-admin/img/tutorial_users_list_selected_columns.png)
...
You’ve just met the `<TextField>` and the `<EmailField>` components. React-admin provides [many more Field components](https://marmelab.com/react-admin/Fields.html), mapping various data types: number, date, image, HTML, array, relationship, etc.
...
[![Url Field](https://marmelab.com/react-admin/img/tutorial_url_field.png)](https://marmelab.com/react-admin/img/tutorial_url_field.png)
...
[![Custom styles](https://marmelab.com/react-admin/img/tutorial_custom_styles.png)](https://marmelab.com/react-admin/img/tutorial_custom_styles.png)
...
[![Guessed Post List](https://marmelab.com/react-admin/img/tutorial_guessed_post_list.png)](https://marmelab.com/react-admin/img/tutorial_guessed_post_list.png)
...
[![Post List With User Names](https://marmelab.com/react-admin/img/tutorial_list_user_name.png)](https://marmelab.com/react-admin/img/tutorial_list_user_name.png)
...
[![Post List With Less Columns](https://marmelab.com/react-admin/img/tutorial_post_list_less_columns.png)](https://marmelab.com/react-admin/img/tutorial_post_list_less_columns.png)
...
[![Post Edit Guesser](https://marmelab.com/react-admin/img/tutorial_edit_guesser.gif)](https://marmelab.com/react-admin/img/tutorial_edit_guesser.gif)
...
[![Post Creation](https://marmelab.com/react-admin/img/tutorial_post_create.gif)](https://marmelab.com/react-admin/img/tutorial_post_create.gif)
...
[![Undo Post Editing](https://marmelab.com/react-admin/img/tutorial_post_edit_undo.gif)](https://marmelab.com/react-admin/img/tutorial_post_edit_undo.gif)
...
[![Post Edit Title](https://marmelab.com/react-admin/img/tutorial_post_title.png)](https://marmelab.com/react-admin/img/tutorial_post_title.png)

This component uses the same `useRecordContext` hook as the custom `<UrlField>` commponent described earlier.

As users can access the post editing page directly by its url, the `<PostTitle>` component may render _without a record_ while the `<Edit>` component is fetching it. That’s why you must always check that the `record` returned by `useRecordContext` is defined before using it - as in `PostTitle` above.
...
[![posts search engine](https://marmelab.com/react-admin/img/filters.gif)](https://marmelab.com/react-admin/img/filters.gif)
...
[![custom menu icons](https://marmelab.com/react-admin/img/custom-menu.gif)](https://marmelab.com/react-admin/img/custom-menu.gif)
...
[![Custom home page](https://marmelab.com/react-admin/img/dashboard.png)](https://marmelab.com/react-admin/img/dashboard.png)
...
[![Login form](https://marmelab.com/react-admin/img/login.gif)](https://marmelab.com/react-admin/img/login.gif)
...
`DELETE http://my.api.url/posts?filter={"id":[123,124,125]}`
...
-   [The Store](https://marmelab.com/react-admin/Store.html)

To help you close the gap between theoritical knowledge and practical experience, take advantage of the react-admin [Demos](https://marmelab.com/react-admin/Demos.html). They are great examples of how to use react-admin in a real world application. They also show the best practices for going beyond simple CRUD apps.